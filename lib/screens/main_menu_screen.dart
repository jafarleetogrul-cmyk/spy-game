          ...
          child: Padding(
            ...
            child: Column(children: [
                ...
                GlassCard(
                  ...
                  child: Row(children: [
                    ...
                    Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Text('${user.stats.totalPoints} ${L.t('points')} • ${user.stats.gamesPlayed} ${L.t('games_played')}',
              ...
              Row(children: [
                ...
                const SizedBox(width: 10),
                Expanded(child: _SecBtn(icon: Icons.menu_book, label: L.t('rules'), route: '/rules')),
                const SizedBox(width: 10),
  ...
  Widget build(BuildContext context) => GestureDetector(
    ...
    child: Container(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Text(label, style: const TextStyle(color: AppTheme.textSub, fontSize: 10), textAlign: TextAlign.center, maxLines: 1, overflow: TextOverflow.ellipsis),
      ]),
    ),
  );
}
