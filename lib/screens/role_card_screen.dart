...
class _RoleCardScreenState extends State<RoleCardScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _flipAnim = Tween(begin: 0.0, end: 1.0).animate(CurvedAnimation(parent: _flipCtrl, curve: Curves.easeInOutBack));
  }
          ...
          child: Padding(
            ...
            child: Column(children: [
              ...
              Container(
                ...
                child: Text('${L.t('round')} ${card.roundNumber} / ${card.roundsCount}',
                  style: const TextStyle(color: AppTheme.textSub, fontSize: 14, fontWeight: FontWeight.w500)),
              ).animate().fadeIn(),
              const Spacer(),
              Text(_isFlipped ? 'Kartınızı gizlədin!' : L.t('tap_to_flip'),
                style: TextStyle(color: AppTheme.textSub.withOpacity(0.8), fontSize: 14),
                    ...
                    return Transform(
                      ...
                      child: isFront
                          ...
                          : Transform(
                              ...
                              child: _buildFront(card.isSpy, card.place),
                            ),
                    );
                  },
                ),
  ...
  Widget _buildBack() {
    return Container(
      ...
      child: const Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        Icon(Icons.visibility_off, color: Colors.white54, size: 80),
        SizedBox(height: 20),
        Text('Toxunun\nçevirmək üçün', textAlign: TextAlign.center,
          style: TextStyle(color: Colors.white70, fontSize: 18, height: 1.4)),
      ]),
    );
  }

  Widget _buildFront(bool isSpy, String? place) {
    return Container(
      width: 300, height: 420,
      decoration: BoxDecoration(
      ...
      child: Padding(
        ...
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          const SizedBox(height: 24),
          Text(isSpy ? L.t('you_are_spy') : L.t('you_are_civil'),
          ...
          const SizedBox(height: 20),
          if (isSpy) ...[
            const Icon(Icons.help_outline, color: Colors.white60, size: 32),
